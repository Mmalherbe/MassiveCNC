...
namespace Assets.Scripts.classes.Font
{
	...
	public class Path
	{
		[XmlAttribute(AttributeName = "connector-curvature", Namespace = "http://www.inkscape.org/namespaces/inkscape")]
		public string Connectorcurvature { get; set; }
